 ...
 *
 * Lives in the (tabs) group so it shows up as a bottom tab (see
 * app/(tabs)/_layout.tsx) — this file's route is still "/search" since
 * a group segment isn't part of the URL, matching Routes.search and the
 * existing Side Menu entry, so nothing else needed to change.
 */
